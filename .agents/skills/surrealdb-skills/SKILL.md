...
description: >
  ...
  permissions, indexing, migrations, realtime features, and Rust SDK usage.
...
Comprehensive guide for building production-grade SurrealDB 2.x systems with the Rust SDK. This skill bundles rule documents for schema design, query safety, permissions, migrations, performance, realtime features, and operational review.
...
| 3        | Auth & Permissions           | `auth-`   | 10    |
| 4        | Rust SDK Integration         | `rust-`   | 12    |
| 5        | Indexing & Performance       | `perf-`   | 10    |
| 6        | Transactions & Consistency   | `txn-`    | 8     |
| 7        | Realtime, Events & Functions | `rt-`     | 10    |
| 8        | Migrations & Deployment      | `mig-`    | 10    |
| 9        | Testing & Observability      | `test-`   | 8     |
| 10       | Anti-patterns                | `anti-`   | 8     |
...
- `Good` example using SurrealQL or the Rust SDK
- `See Also` links to adjacent rules

The most important SurrealDB rules should carry executable-looking examples first: schema, query safety, auth, and Rust SDK integration.
